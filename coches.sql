...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2018 a las 23:07:33
...
INSERT INTO `camion` (`cargamax`, `tipocarga`, `cap_comb`, `id`) VALUES
(500, 'Refrigerada', 500, 4),
(10000, 'Valiosa', 10000, 6);
...
('5689KGJ', 40000, '2018-02-03', 'A12345678', '12345678A', ' ', 'si'),
('1269JKL', 20000, '2018-02-26', 'L32165478', '21345678B', ' ', 'si');
...
('2341KJD', 'Lunas tintadas', 200, 'si'),
('1269JKL', 'Cambio de rueda', 50, 'si');
...
('1111KYD', 'mercedes', 'benz', 22, 'Diesel', 5, 4, 'no'),
('1234BFG', 'seat', 'leon', 5000, 'diesel', 5, 1, 'no'),
('1269JKL', 'citroen', 'C5', 500, 'Gasolina', 2, 6, 'si'),
('2341KJD', 'bmw', 'Q7', 5000, 'Diesel', 5, 5, 'si'),
('2413JGF', 'skoda', 'fabia', 3300, 'diesel', 5, 2, 'no'),
...
('1111KYD', 15000, '2018-02-15', '98564132Z', '21345678B', '', 'si'),
('2413JGF', 80000, '2018-02-07', '65478123G', '21356478G', '', 'si');
